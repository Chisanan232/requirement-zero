...
directly: "The engineer's framing … applies the inference 'no traffic means no purpose' to exactly
the case where that inference is most expensive to get wrong." That is the anti-heuristic the skill
